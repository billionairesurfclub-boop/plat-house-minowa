  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="mt-16 bg-gray-900 text-white rounded-2xl p-8 text-center">
        <p className="font-bold text-lg mb-2">ぷらっとハウス三ノ輪</p>
        <p className="text-gray-400 text-sm mb-6">三ノ輪駅6分・民泊・最大2名</p>
        <a
          href="https://beds24.com/booking.php?propid=334068&referer=BookingLink"
